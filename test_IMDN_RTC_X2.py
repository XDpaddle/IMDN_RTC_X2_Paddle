...
parser.add_argument("--checkpoint", type=str, default='IMDN_RTC_checkpoint_x2/best.pdparams',
...
model = architecture.IMDN_RTC(upscale=opt.upscale_factor)
...
for imname in filelist:
    ...
    im_input = paddle.to_tensor(im_input,dtype='float32')
